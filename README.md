...
- [takuti/flurs](https://github.com/takuti/flurs) ([0.0.5](https://github.com/takuti/flurs/releases/tag/0.0.5), 5 days ago) - :ocean: FluRS: A Python library for streaming recommendation algorithms
...
- [Implement MovieLens100k data file parser](https://github.com/takuti/Recommendation.jl/pull/31) on [takuti/Recommendation.jl](https://github.com/takuti/Recommendation.jl) (1 day ago)
- [Rename `build!` to `fit!` to align with the ML standard](https://github.com/takuti/Recommendation.jl/pull/28) on [takuti/Recommendation.jl](https://github.com/takuti/Recommendation.jl) (3 days ago)
